...
date = os.date("%Y%m%d")
if date >= Date then
gg.alert("🛑sᴄʀɪᴘᴛ sᴜ̈ʀᴇsɪ ᴅᴏʟᴍᴜşᴛᴜʀ...! ➕ɢᴜ̈ɴᴄᴇʟ sᴄʀɪᴘᴛɪ ᴛᴇʟᴇɢʀᴀᴍ ᴀᴅʀᴇsɪᴍᴅᴇɴ ɪɴᴅɪʀ...") 
os.exit()
end

gg.alert(" Güncel Game Guardian Ayarı\n💾ʙᴇʟʟᴇᴋ ᴀʀᴀʟɪᴋʟᴀʀɪ \n💚ᴛᴜ̈ᴍ ʏᴇşɪʟᴇʀ ♦️ᴛᴇᴋ ᴋɪʀᴍɪᴢɪ \n❄ʀᴀᴍ ᴅᴀᴋɪ ᴠᴇʀɪʟᴇʀ ʜᴀʏɪʀ \n☄ᴏ̈ɴʟᴇ ʙᴏşᴀʟᴛ: sᴇᴠiʏᴇ 3 \n🌀 ᴏʏᴜɴᴅᴀ ɢᴀᴍᴇ ɢᴜᴀʀᴅɪᴀɴ ɢɪᴢʟᴇ: (2ᵛᵉ3) \n🎯ᴅᴏɴᴅᴜʀᴍᴀ ᴀʀᴀʟɪɢ̆ɪ: 0")


gg.toast("Yᴜ̈ᴋʟᴇɴɪʏᴏʀ...\n▓▒▒▒▒▒▒▒▒▒10%")
gg.sleep(260)
gg.toast("Yᴜ̈ᴋʟᴇɴɪʏᴏʀ...\n▓▓▒▒▒▒▒▒▒▒20%")
gg.sleep(260)
gg.toast("Yᴜ̈ᴋʟᴇɴɪʏᴏʀ...\n▓▓▓▒▒▒▒▒▒▒30")
...
gg.toast("Yᴜ̈ᴋʟᴇɴɪʏᴏʀ...\n▓▓▓▓▓▓▓▓▓▓100%")
gg.sleep(260)
gg.toast("💠𝚁𝙴𝙻𝙰𝚇❋[𝙷𝙰𝙲𝙺 𝙲𝙷𝙰𝚃]💠️")
gg.sleep(260)
gg.toast("🔥sᴄʀɪᴘᴛ ᴀᴄ̧ɪʟᴅɪ🔥")
gg.setVisible(true)
function HME()
AB = gg.multiChoice({
"🛡Aɴᴛɪʙᴀɴ Mᴇɴᴜ \n ╚➤[𖣘Lᴏʙɪᴅᴇ𖣘] \n",
...
EGL = gg.multiChoice({
"🚙 Aʀᴀʙᴀ Uᴄ̧ᴜʀᴍᴀ \n╚❑[Oʏᴜɴ]",
"⬆️ Uʟᴛʀᴀ Yᴜ̈ᴋsᴇɢ̆ᴇ Zɪᴘʟᴀʸᵉⁿⁱ\n╚❑[Oʏᴜɴ]",
"🚁 Hɪᴢʟɪ Pᴀʀᴀşᴜ̈ᴛ\n╚❑[Oʏᴜɴ]",
"🐎 Fʟᴀsʜᵃᶜ\n╚❑[Oʏᴜɴ]",
"🐎 Fʟᴀsʜᵏᵃᵖᵃᵗ\n╚❑[Oʏᴜɴ]",
"❌ Uʟᴛʀᴀ Yᴜ̈ᴋsᴇɢ̆ᴇ Zɪᴘʟᴀ Kᴀᴘᴀᴛ\n╚❑[Oʏᴜɴ]",
"🔙🅶🅴🆁🅸"
},nil,"╭════════𝚁𝙴𝙻𝙰𝚇❋[𝙷𝙰𝙲𝙺 𝙲𝙷𝙰𝙽𝙽𝙴𝙻]═══════╮\n 𝚁𝙴𝙻𝙰𝚇❋[𝙷𝙰𝙲𝙺 𝙲𝙷𝙰𝙽𝙽𝙴𝙻] Sᴄʀɪᴘᴛ🖤 \n╰════════𝚁𝙴𝙻𝙰𝚇❋[𝙷𝙰𝙲𝙺 𝙲𝙷𝙰𝙽𝙽𝙴𝙻]═══════╯")
if EGL == nil then
else
if EGL[1] == true then
ucur()
...
gg.clearResults()
gg.setRanges(gg.REGION_CODE_APP)
gg.searchNumber("-1328550408578809999", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(8000000)
...
gg.refineNumber("1,873,498,234,778,812,416", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.refineNumber("1,873,498,234,778,812,416", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(1401)
...
gg.refineNumber("403,635,275,035,574,272", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.refineNumber("403,635,275,035,574,272", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(1401)
...
gg.refineNumber("-2,044,616,634,647,180,800", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.refineNumber("-2,044,616,634,647,180,800", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(1401)
...
gg.refineNumber("-1296744153870237696", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.refineNumber("-1296744153870237696", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(1401)
gg.editAll("-1296744149883614555", gg.TYPE_QWORD)
gg.clearResults()
gg.toast("❌ Flash Kapandı ❌")
end
...
gg.clearResults()
gg.toast("🦎 M416 KERTENKELE KÜKREMESİ AKTİF ✔️")
end
...
gg.clearResults()
gg.toast("❄️ BUZ DİYARI M416 AKTİF ✔️")
end
...
gg["editAll"]("288232579469934592", gg.TYPE_DWORD) 
gg["clearResults"]() 
gg.toast("🔰BYPASS AKTİF🔰") 
gg.alert("●▬▬▬▬▬▬๑☾︎ 𝚁𝙴𝙻𝙰𝚇❋[𝙷𝙰𝙲𝙺 𝙲𝙷𝙰𝚃]☽︎๑▬▬▬▬▬▬● \n 🛡️ ᎪΝͲᏆᏴᎪΝ ᎪᏟ̧ᏆᏞᎠᏆ ✅\n ✨️ႮᏟᎡᎬͲՏİᏃ ᎻİᏞᎬ  \n 👻ՏᎪҒᎬ ϴᎽΝᎪ = ᗯIᑎ 👑@efe_3162 \n ●▬▬▬▬▬▬๑☾︎ 𝚁𝙴𝙻𝙰𝚇❋[𝙷𝙰𝙲𝙺 𝙲𝙷𝙰𝚃]☽︎๑▬▬▬▬▬▬●")
end
...
os.remove("src/main/java/com/google/errorprone/annotations")
  ...
  gg.refineNumber("1.88696049e-40", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
  ...
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_CODE_APP)
  gg.searchNumber("1.85108725e-40", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
  gg.refineNumber("1.85108725e-40", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
  revert = gg.getResults(99999, nil, nil, nil, nil, nil, nil, nil, nil)
  gg.editAll("1.55179048e-36", gg.TYPE_FLOAT)
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_CODE_APP)
  gg.searchNumber("1.89054781e-40", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
  gg.refineNumber("1.89054781e-40", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
  revert = gg.getResults(99999, nil, nil, nil, nil, nil, nil, nil, nil)
  gg.editAll("1.55179048e-36", gg.TYPE_FLOAT)
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_CODE_APP)
  gg.searchNumber("1.75820918e-41", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
  gg.refineNumber("1.75820918e-41", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
  revert = gg.getResults(99999, nil, nil, nil, nil, nil, nil, nil, nil)
  gg.editAll("1.55179048e-36", gg.TYPE_FLOAT)
  gg.clearResults()
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_CODE_APP)
  gg.searchNumber("2.02329281e-40", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
  gg.refineNumber("2.02329281e-40", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
...
"❌X Hasar Efekti \n╚❑[Oʏᴜɴ]",
"🌟Magic Full HS \n╚❑[Oʏᴜɴ]",
"💥 Magic + Kafadan Vurma AWM Etkisi \n╚❑[Oʏᴜɴ]",
"🔫 Less Recoil \n╚❑[Lobi + Oyun]",
"🎯 No Recoil \n╚❑[Lobi + Oʏᴜɴ]",
"🏹 Bullet Tracking \n╚❑[Oʏᴜɴ]",
"💢 Yüksek Hasar \n╚❑[Oʏᴜɴ]",
...
"🧨 Hızlı Mermi++++ \n╚❑[Oʏᴜɴ]",
"✅ İleri Uzanan Kolᵃᶜ \n╚❑[Oʏᴜɴ]",
"❌ İleri Uzanan Kolᵏᵃᵖᵃᵗ \n╚❑[Oʏᴜɴ]",
"✅ Yukarı Uzanan Kolᵃᶜ \n╚❑[Oʏᴜɴ]",
"❌️ Yukarı Uzanan Kolᵏᵃᵖᵃᵗ \n╚❑[Oʏᴜɴ]",
"🔙Gᴇʀɪ",
},nil,"╭════════𝚁𝙴𝙻𝙰𝚇❋[𝙷𝙰𝙲𝙺 𝙲𝙷𝙰𝙽𝙽𝙴𝙻]═══════╮\n 𝚁𝙴𝙻𝙰𝚇❋[𝙷𝙰𝙲𝙺 𝙲𝙷𝙰𝙽𝙽𝙴𝙻] V4 ՏᏟᎡᏆᏢͲ🖤 \n Telegram : @RelaxHACKK  \n ╰════════Relax HACK═══════╯")
...
gg.clearResults()
gg.toast("Yükarı uzayan kol Kapandı❌")
end
...
gg.clearResults()
gg.toast("MAGİC AWM ETKİSİ AKTİF💎")
end
...
gg.clearResults()
gg.toast("İleri Uzayan Kol Aktif✅")
end
...
gg.clearResults()
gg.toast("İleri Uzayan Kol Devre Dışı❌")
end
...
gg.editAll("9999", gg.TYPE_FLOAT)
gg.clearResults()
gg.toast("✖️ Hasar Efekti Aktif ✖️")
end
...
function EXIT()
print("💠Bɪᴢɪ Tᴇʀᴄɪʜ Eᴛᴛɪɢ̆ɪɴɪᴢ İᴄ̧ɪɴ Tᴇşᴇᴋᴋᴜ̈ʀ Eᴅᴇʀɪᴢ🤍")
  gg.skipRestoreState()
  gg.setVisible(true)
  os.exit()
end
